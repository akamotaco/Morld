# run_tests.py — 공용 엔진 테스트 러너 (pytest 불필요, SharpPy 호환)
"""
사용법:
    python run_tests.py                # 전체 테스트
    python run_tests.py environment    # 특정 모듈만
...
_python_dir = os.path.abspath(os.path.join(_tests_dir, ".."))  # common/python
...
def main():
    ...
    print("=" * 60)
    print("morld common engine tests")
    print("=" * 60)
