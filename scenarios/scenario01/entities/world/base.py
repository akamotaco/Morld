...
class Edge:
    ...
    def __init__(
        ...
        b: int,
        travel_time: int = 1,
        time_a_to_b: int = None,
        time_b_to_a: int = None,
        conditions_a_to_b: dict = None,
        conditions_b_to_a: dict = None
    ):
        self.a = a
        self.b = b
        # 양방향 시간 (기본값은 travel_time)
        self.time_a_to_b = time_a_to_b if time_a_to_b is not None else travel_time
        self.time_b_to_a = time_b_to_a if time_b_to_a is not None else travel_time
        # 양방향 조건
        self.conditions_a_to_b = conditions_a_to_b or {}
        self.conditions_b_to_a = conditions_b_to_a or {}
    ...
    def register(self):
        ...
        for edge in self.EDGES:
            morld.add_edge_with_conditions(
                ...
                edge.time_a_to_b,
                edge.time_b_to_a,
                edge.conditions_a_to_b,
                edge.conditions_b_to_a
            )
