...
def register():
    """문서류 Asset 등록"""
    registry.register_item(DIARY)
    registry.register_item(OLD_LETTER)
    registry.register_item(STUDY_MEMO)
