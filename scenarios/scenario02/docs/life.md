...
> **v0.2.2에서 욕구 수치화 시스템 구현 완료. v0.2.4에서 점검/취미 활동 시스템 추가.**
>
> **구현된 항목:**
...
> - **점검 활동** → 세력 need 스캔 + 성격 확률 기반 자원 수집 (v0.2.4)
> - **취미 활동** → 조건 없이 수행, 수확물 인벤토리 보관 (v0.2.4)
>
> **미구현 항목:** NPC 주도 상호작용
>
> 현재 구현 상태는 [schedule.md#8](schedule.md#8-v021-phase-시스템) 참조.
> 활동 핸들러 제작 가이드: [make_activity.md](make_activity.md)
> 캐릭터 행동 제어 가이드: [behavior-guide.md](behavior-guide.md)
