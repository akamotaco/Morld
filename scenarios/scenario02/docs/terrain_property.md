...
> - 헤더 UI에 온도 표시 (`22℃`)
> - Location별 습도 시뮬레이션 → `humidity.py`
> - 날씨 강도 시스템 (가랑비/소나기/폭우/폭설/폭염)
> - 캐릭터·오브젝트·아이템 젖음/건조 (온도 연동)
> - 헤더 UI에 습도 + 강도 표시 (`비(소나기) 12℃ 90%`)
>
> **미구현 항목:** 풍속, 달의 위상, 조도(기존 lighting.py와 별도), 체감 온도
>
> 온도 시스템 상세는 [system-gameplay.md#온도-시스템](system-gameplay.md#온도-시스템-temperature-system) 참조.
> 습도 시스템 상세는 [system-gameplay.md#습도-시스템](system-gameplay.md#습도-시스템-humidity-system) 참조.
