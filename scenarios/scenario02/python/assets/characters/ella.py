...
class Ella(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        # Phase 5: 거친 행위 반응
        "nipple_pinch:start": [
            ({"성욕": 70}, ["...크... 아프지만... 이상하군요...", "...꼬집으면... 으... 묘하군요..."]),
            ({}, ["...아프군요.", "...거칠게 하지 마세요."]),
        ],
        "breast_grab:start": [
            ({"성욕": 70}, ["...크...! 거칠게... 하면... 이상하군요...", "...세게 잡으면... 강렬하군요..."]),
            ({}, ["...거칠군요.", "...세게 잡지 마세요."]),
        ],
        "rough_finger:start": [
            ({"성욕": 70}, ["...거칠게... 하면... 강렬하군요...", "...안 돼요... 하지만..."]),
            ({}, ["...아파요... 천천히...", "...너무 거칠군요."]),
        ],
        "rough_thrust:start": [
            ({"성욕": 70}, ["...크...! 깊어... 안쪽까지...", "...거칠게... 하면... 대단하군요..."]),
            ({}, ["...아파요... 천천히 해 주세요...", "...너무 세요."]),
        ],
        "rough_thrust:during": [
        ...
        "hard_anal:start": [
            ({"성욕": 70}, ["...뒤를 세게...? ...말도 안 돼... 하지만...", "...거기는... 이상한 감각이..."]),
            ({}, ["...안 돼요... 그쪽은 무리예요...", "...아파요... 그만둬요..."]),
        ],
        "hard_anal:during": [
        ...
        "thrust_deep:start": [
            ({"성욕": 70}, ["...깊군요...! 안쪽까지... 닿아요...", "...거기 닿으면... 이상하군요..."]),
            ({}, ["...너무 깊어요...", "...아파요..."]),
        ],
        "thrust_slow:start": [
            ({"성욕": 70}, ["...천천히... 전부 느껴져요...", "...이렇게 하면... 강렬하군요..."]),
            ({}, ["...으...", "...(눈을 피한다)"]),
        ],
        "grind:start": [
            ({"성욕": 70}, ["...안에서 움직이면... 이상하군요...", "...거기 누르면... 참을 수 없어..."]),
            ({}, ["...움직이지 마세요...", "..."]),
        ],
        "ejaculate:start": [
            ({"성욕": 70}, ["...뜨겁군요... 안에... 뜨거워...", "...(몸을 떨며 감각을 받아들인다.)"]),
            ({}, ["...(조용히 몸을 떤다.)", "..."]),
        ],
