...
class Faye(Character):
    ...
    props = {
        ...
        "외모:붉은단발": 1, "외모:황금색눈": 1,
        "성격:자신만만": 1, "성격:실용적": 1,
        # Phase 2 성격 7 trait override (proud 베이스 + 츤데레 성향)
        "성격:츤데레": 1,  # proud 기본 0 → 1
        "나이": 17,
        "상태:성욕": 0, "상태:질투": 0,
        "상태:피로": 0, "상태:기분": 5,
        "can:lie_down": 1,
    ...
    ROMANCE_REACTIONS = {
        "hug:start": [
            ...
            ({"once": True}, ["...허락한 적 없는데."]),
            ({}, ["...흥, 이런 서비스는 공짜인데.", "...(못 이기는 척 안긴다)", "...특별히 허락해주지."]),
        ],
        "french_kiss:start": [
        ...
        "ejaculation_internal_음부:start": [
            ({"배란": True, "반발": 15}, ["...하필 오늘? ...배란일인 걸 알고 있었나?", "...(차가운 눈) ...각오해. 임신은 확정이야."]),
            ({"배란": True}, ["...오늘은 배란일이야. ...책임질 거지?", "...(담담히) ...결과는 받아들이겠어. 네 아이, 만들어 주지."]),
            ({"반발": 30}, ["...안에...? ...죽여버린다.", "...(살기가 폭발한다)"]),
            ({"성욕": 80, "경험:질내사정": 5}, ["...안에 쏟아. 상관없어.", "...또 임신이라도 하는 거야?"]),
            ({"경험:질내사정": 3}, ["...또야? ...이제 익숙해.", "...예상 범위야."]),
            ({}, ["...안에... 대담하네.", "...(숨을 고르며) ...뜨겁잖아.", "...값은 톡톡히 받아내지."]),
        ],
        "ejaculation_internal_항문:start": [
            ({"반발": 30}, ["...뒤에 쏟다니... 죽여버린다.", "...(살의가 폭발한다) ...취향 참 더럽군."]),
            ({"성욕": 80, "경험:항문": 5}, ["...뒤에도 쏟아. 상관없어.", "...엉덩이도 내 거였잖아?"]),
            ({"경험:항문": 3}, ["...또 뒤야? ...익숙해져 가.", "...예상은 했어."]),
            ({}, ["...뒤라니... 별난 취향이야.", "...(허리를 떨며) ...큭.", "...흥, 특별 요금이야."]),
        ],
        "ejaculation_internal_구강:start": [
            ({"반발": 30}, ["...입에...? (차가운 살기) ...뱉어낼 거야.", "...(싸늘하게 입을 연다.) ...각오해."]),
            ({"성욕": 80, "경험:구강": 5}, ["...입에 쏟아. 상관없어.", "...(담담하게 머금는다.)"]),
            ({"경험:구강": 3}, ["...또 입이야? ...익숙해.", "...예상은 했어."]),
            ({}, ["...(입에 받아 우아하게 삼킨다)", "...(입가를 훔치며) ...흥.", "...이런 것도 서비스인 줄 알아."]),
        ],

        # 체내 정액 최대치 도달 (overflow)
        "ejaculation_internal_음부_overflow:start": [
            ({"반발": 15}, ["...포화야. (차가운 한숨) ...양을 조절해.", "...(흘러넘치는 정액) ...정말이지."]),
            ({}, ["...배 안이 가득이군. (담담히)", "...(허벅지로 흐른다) ...꽤 쏟았어."]),
        ],
        "ejaculation_internal_항문_overflow:start": [
            ({"반발": 15}, ["...뒤도 넘쳐. ...변태.", "...(흘러내리는 정액) ...양 조절도 못해?"]),
            ({}, ["...뒤도 한계군. (차분히)", "...(허벅지로 흐른다) ...예상 이상이야."]),
        ],
        "ejaculation_internal_구강_overflow:start": [
            ({"반발": 15}, ["...(입 밖으로 흐른다) ...최악이야.", "...(차갑게 뱉는다) ...양을 조절해."]),
            ({}, ["...(입 가득 머금은 채 흐른다) ...예상 이상이군.", "...(턱을 닦는다) ...꽤 많아."]),
        ],

        # raw 질삽입 경고 (콘돔 없이)
        "raw_vaginal_warning:start": [
            ({"반발": 15}, ["...콘돔 없이? ...어지간하군.", "...(차가운 눈) ...책임질 수 있나?"]),
            ({}, ["...콘돔 생략이군. (담담히)", "...(살짝 미간) ...각오 돼 있군."]),
        ],
        "ecstasy:start": [
            ...
            ({}, ["...큭... 제법이잖아...!", "...(품위를 지키려 하지만 몸을 떤다)", "...이 정도로... 우쭐대지 마."]),
        ],
        # 외부 사정 부위별 반응 (pull_out_target)
        "pull_out_얼굴:start": [
            ({"반발": 15}, ["...얼굴에...? (차가운 살기) ...각오해.", "...(빙결된 표정) ...이런 모욕을."]),
            ({"성욕": 80}, ["...얼굴에... (담담히 받아들인다) ...재미있군.", "...(볼에 묻은 정액을 손끝으로 닦는다) ...꽤 뜨거운데."]),
            ({}, ["...얼굴이야? (차갑게 닦는다)", "...(한숨) ...기억해둬."]),
        ],
        "pull_out_가슴:start": [
            ({"반발": 15}, ["...가슴에... (팔로 가린다) ...이런 짓을.", "...(차갑게 내려다본다) ...모욕이야."]),
            ({"성욕": 80}, ["...가슴에... (담담히 정액을 만진다) ...뜨거워.", "...(가슴 위 정액을 느낀다) ...꽤 양이 많아."]),
            ({}, ["...가슴에 묻었군. (내려다본다)", "...(닦으려 손을 뻗는다) ...예상은 했어."]),
        ],
        "pull_out_배:start": [
            ({"반발": 15}, ["...배에... 끈적해. (찡그린다)", "...(배 위를 닦으며) ...최악이야."]),
            ({"성욕": 80}, ["...배에... 뜨거워. (배를 매만진다)", "...(배 위 정액을 손끝으로 훑는다) ...꽤 많아."]),
            ({}, ["...배에 나왔어. (내려다본다)", "...(배를 닦는다) ...예상 범위야."]),
        ],
        "pull_out_엉덩이:start": [
            ({"반발": 15}, ["...엉덩이에... (어깨 너머로 노려본다) ...취향 참 더럽군.", "...(허리를 비튼다) ...모욕이야."]),
            ({"성욕": 80}, ["...엉덩이에... (살짝 허리를 든다) ...특이하네.", "...(엉덩이 위 정액을 느낀다) ...뜨거워."]),
            ({}, ["...엉덩이에. (뒤돌아본다)", "...(닦으려 손을 뻗는다) ...예상은 했어."]),
        ],
        ...
        # ── NPC 자율 봉사/자위 (Phase 1.6) ──
        "npc_autonomy:start": [
            ({"성욕": 90}, ["\"...내가 할게. 가만히 있어.\" 페이가 주도권을 잡았다.", "페이가 당당히 스스로 행동에 나섰다."]),
            ({}, ["페이가 스스로 움직이기 시작했다.", "페이가 자신만만하게 주도하기 시작했다..."]),
        ],
        "npc_autonomy:switch": [
            ({}, ["페이가 방식을 바꿨다.", "페이가 잠시 멈췄다가 다른 방식으로 시작했다..."]),
        ],
        "npc_autonomy_fellatio:start": [
            ({"성욕": 90}, ["\"...감사히 받아.\" 페이가 입에 머금었다.", "페이가 당당한 눈빛으로 입에 가져갔다."]),
            ({}, ["페이가 입으로 가져갔다.", "페이가 태연히 입에 머금었다..."]),
        ],
        "npc_autonomy_penis_rub:start": [
            ({"성욕": 90}, ["\"이렇게 해주길 원해?\" 페이가 손으로 쥐었다.", "페이가 확고한 손길로 문지르기 시작했다."]),
            ({}, ["페이가 손으로 쥐고 움직였다.", "페이가 솜씨 있게 손으로 자극했다..."]),
        ],
        "npc_autonomy_rest:start": [
            ({}, ["페이가 짧게 숨을 고른다.", "\"...잠깐 쉬어.\" 페이가 잠시 멈췄다."]),
        ],
        "npc_autonomy_self_breast:start": [
            ({"성욕": 90}, ["\"...이 정도는 내가 해결해.\" 페이가 당당히 자기 가슴을 어루만졌다."]),
            ({}, ["페이가 자신만만하게 자기 가슴을 쥐었다.", "페이가 당당히 자기 가슴을 만졌다..."]),
        ],
        "npc_autonomy_self_nipple:start": [
            ({"성욕": 90}, ["페이가 확고한 손길로 자기 유두를 자극했다.", "\"...이렇게.\" 페이가 태연히 유두를 건드렸다."]),
            ({}, ["페이가 당당히 유두를 자극했다.", "페이가 주저함 없이 유두를 건드렸다..."]),
        ],
        "npc_autonomy_self_clit:start": [
            ({"성욕": 90}, ["\"이 정도는 내가 해결한다.\" 페이가 스스로 클리토리스를 자극했다."]),
            ({}, ["페이가 당당히 클리토리스를 자극했다.", "페이가 태연히 자기 몸을 건드렸다..."]),
        ],
        "npc_autonomy_self_vaginal:start": [
            ({"성욕": 90}, ["\"...이렇게.\" 페이가 태연하게 손가락을 자기 안에 넣었다."]),
            ({}, ["페이가 주저함 없이 손가락을 자기 안에 집어넣었다.", "페이가 당당히 스스로를 채웠다..."]),
        ],
        "npc_autonomy_self_anal:start": [
            ({"성욕": 90}, ["\"...여기도 괜찮지.\" 페이가 여유 있는 표정으로 항문을 자극했다."]),
            ({}, ["페이가 짐짓 태연히 뒤쪽을 자극했다.", "페이가 당당히 항문을 건드렸다..."]),
        ],
        "npc_insertion_request:vaginal": [
            ({"성욕": 90}, ["\"...넣어. 당장.\"", "\"...이 정도면 알겠지. 삽입해.\""]),
            ({}, ["페이가 당당히 허리를 내밀었다.", "페이가 시선으로 아래를 가리켰다..."]),
        ],
        "npc_insertion_request:anal": [
            ({"성욕": 90}, ["\"...뒤쪽도 괜찮아. 넣어.\"", "\"...해봐. 뒤로도.\""]),
            ({}, ["페이가 태연히 엉덩이를 돌렸다.", "페이가 당당히 뒤쪽을 내보였다..."]),
        ],

        # ── 트랜스 상태 대사 (Phase 1.8) ──
        "trance:start": [
            ({}, ["\"...하... 젠장... 아...\"", "\"...하... 이런... 하아...\"", "페이가 숨을 거칠게 내쉬었다..."]),
        ],
        "trance_deep:start": [
            ({}, ["\"...아으... 하... 히읏...\"", "페이가 자존심을 잃은 채 신음만 흘렸다...", "\"...우... 아... 으...♡\" 페이의 눈빛이 초점을 잃었다.",
                  "\"...{beloved}...!\" 페이가 자기도 모르게 낯선 이름을 불렀다.", "\"...{beloved}...\" 페이의 입술이 이름 하나를 흘렸다."]),
        ],
        "post_trance:start": [
            ({}, ["\"...젠장... 방심했군.\" 페이가 거친 숨을 내쉬며 자세를 고쳤다.", "\"...잊어. 없던 일이야.\" 페이가 단호히 말했지만 뺨은 붉게 물들어 있었다.", "페이가 눈을 감고 호흡을 가다듬었다. \"...이런 꼴을... 후.\""]),
        ],
