...
class Lina(Character):
    ...
    props = {
        ...
        "성격:명랑함": 1, "성격:활발함": 1,
        # Phase 2 성격 7 trait override (cheerful 베이스 + 겁 많은 밝은 소녀)
        "성격:담력": -1,   # cheerful 기본 0 → -1
        "성격:자존심": -1, # cheerful 기본 0 → -1
        "성격:정조": 1,    # cheerful 기본 0 → 1
        "관계:세라:신뢰": 1,
        "나이": 19,
        "상태:성욕": 0, "상태:질투": 0,
        "상태:피로": 0, "상태:기분": 7,
    ...
    ROMANCE_REACTIONS = {
        ...
        "hug:start": [
            ...
            ({}, ["에헤헤~ 따뜻해!", "...(폭 안긴다) 좋아~", "헤헤, 이러고 있으니까 좋다~"]),
        ],
        ...
        "nipple_lick:start": [
            ...
            ({}, ["히읏! 거기 간지러워~!", "...(몸을 배배 꼰다) 헤헤...", "핥지 마~ 이상하다구!"]),
        ],
        "nipple_suck:start": [
            ({"상태:수유": 1}, ["빠, 빨면 나와...!! 모유가...!!", "으으...! 나온다고...! 부끄러워...!"]),
            ({}, ["아, 빨면...! 헤엣...", "...(가슴을 맡기며) 으응~", "그렇게 빨면... 이상해져~"]),
        ],
        "nipple_suck:during": [
        ...
        "ejaculation_internal_음부:start": [
            ({"배란": True, "반발": 15}, ["하필 오늘...! 배란일이잖아...!", "미쳤어...?! 오늘 안에 쏟으면...! 임신해버린다고...!", "...!! 이... 이상한 날에... 왜...!"]),
            ({"배란": True}, ["오늘...? 오늘 안에 쏟다니... 임신할 수도 있어...♡", "...(얼굴이 붉어진다) ...배란일인데... 진심이야...?", "...안에... 가득... 아이가 생길지도... 몰라...♡"]),
            ({"반발": 30}, ["안에 싸지 마!! 꺼내라고!!", "더러워!! 빼!! 빨리!!", "...!! 미쳤어?! 안에 쏟다니!!"]),
            ({"반발": 15}, ["...안에는 싫다고 했잖아...", "...왜 안에 쏴... 최악이야..."]),
            ({"성욕": 80, "경험:질내사정": 5}, ["안에... 쏟아줘... 더...♡", "뜨거운 거... 좋아...♡"]),
            ({"경험:질내사정": 3}, ["또...? ...이제 놀라지도 않아...", "...안에... 또..."]),
            ({}, ["아, 안에...! 뜨거워~!", "...(움찔) 가득 찼어...!", "헤헤... 안에 다 나왔네..."]),
        ],
        "ejaculation_internal_항문:start": [
            ({"반발": 30}, ["뒤에...?! 미쳤어?! 변태!!", "엉덩이에...! 빼!! 더러워!!", "...!! 그런 곳에 쏟지 마!!"]),
            ({"반발": 15}, ["...뒤쪽은 싫다고 했잖아...", "...왜 거기에... 최악이야..."]),
            ({"성욕": 80, "경험:항문": 5}, ["뒤도... 좋아...♡ 쏟아줘...", "엉덩이에... 뜨거워...♡"]),
            ({"경험:항문": 3}, ["또 뒤에...? 이제는 괜찮아...", "...엉덩이도... 익숙해졌어..."]),
            ({}, ["뒤에...! 아, 이상해~!", "...(엉덩이를 떨며) 히읏...!", "이상한 느낌이야~..."]),
        ],
        "ejaculation_internal_구강:start": [
            ({"반발": 30}, ["입 안에...?! 으엑! 뱉을 거야!!", "...!! 입에다...! 최악...!!", "컥...! 꺼내!! 역겨워!!"]),
            ({"반발": 15}, ["...입 안에는... 왜...", "...(삼키지 못하고 입을 떤다)"]),
            ({"성욕": 80, "경험:구강": 5}, ["입에... 가득...♡ ...으응...", "...더... 입에 쏟아줘...♡"]),
            ({"경험:구강": 3}, ["또 입에...? 이제 놀라지도 않아...", "...익숙해... 이런 거..."]),
            ({}, ["...(입에 받고 눈을 동그랗게) ...음!", "...(꿀꺽 삼킨다) 우와...", "...입에 다 나왔어~..."]),
        ],

        # 체내 정액 최대치 도달 (overflow)
        "ejaculation_internal_음부_overflow:start": [
            ({"반발": 15}, ["...배 안이... 터질 거 같아...! 그만!!", "...(흘러넘치는 정액을 느끼며) ...더는 안 돼...!"]),
            ({}, ["...배 안이... 가득...♡ 넘쳐버려...", "...(정액이 역류한다) ...이렇게까지...♡ 꽉 찼어..."]),
        ],
        "ejaculation_internal_항문_overflow:start": [
            ({"반발": 15}, ["...뒤가... 터질 것 같아...! 변태!!", "...(엉덩이 안 정액이 흘러내린다) ...더는 무리야..."]),
            ({}, ["...뒤쪽이... 가득...♡ 흘러나와...", "...(엉덩이 밖으로 정액이 샌다) ...많이도 쏟았네..."]),
        ],
        "ejaculation_internal_구강_overflow:start": [
            ({"반발": 15}, ["...입 안이... 터질 것 같아...! 우욱...!", "...(입 안 정액이 흘러내린다) ...너무 많아..."]),
            ({}, ["...입이... 가득...♡ (흘러내린다)", "...(뺨으로 정액이 흐른다) ...삼킬 수 없어..."]),
        ],

        # raw 질삽입 경고 (콘돔 없이)
        "raw_vaginal_warning:start": [
            ({"반발": 15}, ["...콘돔도 없이...?! 미쳤어?!", "...안에다 직접...? 책임질 거야?"]),
            ({}, ["...콘돔 안 끼는구나... (볼이 붉어진다)", "...(살짝 긴장) ...진심이야...? 이대로...?"]),
        ],
        ...
        "ecstasy:start": [
            ...
            ({}, ["아, 안 돼~ 이상해져...!", "...(몸을 떨며) 히읏...!", "이런 거... 부끄럽단 말야~!"]),
        ],

        # 외부 사정 부위별 반응 (pull_out_target)
        "pull_out_얼굴:start": [
            ({"반발": 15}, ["...으악!! 얼굴에...!! 더러워!!", "...!! 눈에...!! 미쳤어?!"]),
            ({"성욕": 80}, ["...얼굴에...♡ (눈을 감고 받아들인다) ...뜨거워...", "...하앗...♡ 얼굴에... 다 묻었어..."]),
            ({}, ["...얼굴에...?! (당황하며 닦으려 한다)", "...(볼에 묻은 채 얼어붙는다) ...왜 하필..."]),
        ],
        "pull_out_가슴:start": [
            ({"반발": 15}, ["...가슴에... 더러워!! 씻을래!!", "...!! 왜 그런 곳에...!"]),
            ({"성욕": 80}, ["...가슴에... 뜨거워...♡ ...좋아...", "...(가슴을 감싸며) ...하앗... 끈적해..."]),
            ({}, ["...가슴에 묻었잖아... (빨개진다)", "...(가슴을 내려다보며) ...이거 어떡해..."]),
        ],
        "pull_out_배:start": [
            ({"반발": 15}, ["...배에...!! 빨리 닦을 거야!!", "...끈적해... 싫어..."]),
            ({"성욕": 80}, ["...배 위에...♡ ...따뜻해...", "...(배에 묻은 정액을 바라본다) ...많이도... 쏟았네♡"]),
            ({}, ["...배에 나왔어... (배를 내려다본다)", "...끈적해... 닦아야겠어..."]),
        ],
        "pull_out_엉덩이:start": [
            ({"반발": 15}, ["...엉덩이에... 변태...!", "...(엉덩이를 닦으려 버둥거린다) ...싫어!"]),
            ({"성욕": 80}, ["...뒤에...♡ 엉덩이 좋았어...?", "...(엉덩이를 살짝 흔들며) ...끈적... 하네♡"]),
            ({}, ["...엉덩이에 묻었어... (어깨 너머로 본다)", "...(닦아내려 손을 뻗는다) ...으..."]),
        ],
        ...
        # ── NPC 자율 봉사/자위 (Phase 1.6 — 성욕 높을 때 스스로 행동) ──
        "npc_autonomy:start": [
            ({"성욕": 90}, ["리나가 참을 수 없다는 듯 몸을 움직이기 시작했다.", "\"...더는 못 참아~♡\" 리나가 스스로 움직이기 시작했다."]),
            ({}, ["리나가 스스로 몸을 움직이기 시작했다.", "리나가 볼을 붉히며 직접 행동에 나섰다..."]),
        ],
        "npc_autonomy:switch": [
            ({}, ["리나가 다른 방식으로 바꿨다.", "리나가 잠시 쉬다가 또 다시 움직이기 시작했다..."]),
        ],
        "npc_autonomy_fellatio:start": [
            ({"성욕": 90}, ["\"직접 해줄게~♡\" 리나가 입으로 가져갔다.", "리나가 볼을 물들이며 입으로 감쌌다..."]),
            ({}, ["리나가 입으로 가져갔다.", "리나가 떨리는 손길로 입에 가져갔다..."]),
        ],
        "npc_autonomy_penis_rub:start": [
            ({"성욕": 90}, ["\"이렇게~?\" 리나가 손으로 잡고 움직이기 시작했다.", "리나가 직접 손을 뻗어 문지르기 시작했다."]),
            ({}, ["리나가 손으로 쥐고 움직이기 시작했다.", "리나가 손놀림으로 자극하기 시작했다..."]),
        ],
        "npc_autonomy_rest:start": [
            ({}, ["리나가 잠시 숨을 고른다.", "\"...하아... 잠시만...\" 리나가 잠깐 멈춰 섰다."]),
        ],
        "npc_autonomy_self_breast:start": [
            ({"성욕": 90}, ["\"...이렇게 만지면... 좋아~♡\" 리나가 스스로 가슴을 감쌌다."]),
            ({}, ["리나가 자기 가슴을 만지기 시작했다.", "리나가 볼을 붉히며 자기 가슴을 감쌌다..."]),
        ],
        "npc_autonomy_self_nipple:start": [
            ({"성욕": 90}, ["\"유두... 자극하면... 찌릿해~♡\" 리나가 스스로 꼬집었다."]),
            ({}, ["리나가 자기 유두를 자극하기 시작했다.", "리나가 수줍게 유두를 건드렸다..."]),
        ],
        "npc_autonomy_self_clit:start": [
            ({"성욕": 90}, ["\"...직접... 해볼게~♡\" 리나가 스스로 클리토리스를 자극했다."]),
            ({}, ["리나가 스스로 클리토리스를 만지기 시작했다.", "리나가 볼을 붉히며 자기 몸을 자극했다..."]),
        ],
        "npc_autonomy_self_vaginal:start": [
            ({"성욕": 90}, ["\"...안쪽이... 간지러워~♡\" 리나가 손가락을 자기 안에 넣었다."]),
            ({}, ["리나가 손가락을 자기 안에 집어넣었다.", "리나가 떨리는 손으로 스스로를 채웠다..."]),
        ],
        "npc_autonomy_self_anal:start": [
            ({"성욕": 90}, ["\"...뒤쪽도... 이상한 느낌이...♡\" 리나가 스스로 항문을 자극했다."]),
            ({}, ["리나가 쑥스러운 표정으로 항문을 자극하기 시작했다.", "리나가 떨리는 손길로 뒤쪽을 건드렸다..."]),
        ],
        "npc_insertion_request:vaginal": [
            ({"성욕": 90}, ["\"...안에 넣어줘~♡ 빨리~!\"", "\"...못 참겠어~ 넣어줘~!\""]),
            ({}, ["리나가 허리를 내밀며 삽입을 재촉했다.", "리나가 조르는 눈빛으로 아래를 가리켰다..."]),
        ],
        "npc_insertion_request:anal": [
            ({"성욕": 90}, ["\"...뒤에도... 해줘~♡\"", "\"...뒤쪽으로 넣어봐~!\""]),
            ({}, ["리나가 엉덩이를 살짝 내밀며 뒤쪽을 내보였다.", "리나가 등을 돌려 엉덩이를 내밀었다..."]),
        ],

        # ── 트랜스 상태 대사 (Phase 1.8) ──
        "trance:start": [
            ({}, ["\"...하아~ 아~ 응~♡\"", "\"...우웅~ 더... 해줘~\"", "\"...헉... 아... 좋아~\""]),
        ],
        "trance_deep:start": [
            ({}, ["\"...아우우... 으아...♡\"", "\"...히잉... 좋아...♡ 아앙...\"", "\"...으흐... 우우... 아...♡\"",
                  "\"...{beloved}...♡ 아...♡\"", "\"...아...♡ {beloved}...\""]),
        ],
        "post_trance:start": [
            ({}, ["\"...어? 나... 방금 뭐 한 거지...?\"", "리나가 숨을 몰아쉬며 얼굴을 가렸다. \"...으으... 부끄러워...\"", "\"...기억 안 나... 그냥 너무 좋았어...\""]),
        ],

        # ── NPC 선호 체위 요구 (대사만, 실제 체위 변경은 플레이어 선택) ──
        "npc_position_request:cowgirl": [
            ({"성욕": 80}, ["\"위에 올라타고 싶어~♡\" 리나가 살짝 몸을 일으키려 한다.", "\"내가 위에 하고 싶어~ 해줘~!\""]),
            ({}, ["리나가 몸을 일으키려는 듯 움직였다.", "리나가 살짝 위로 올라오려 한다..."]),
        ],
        "npc_position_request:standing_face": [
            ({"성욕": 80}, ["\"서서 안아서~ 이렇게 해줘~♡\"", "\"안기고 싶어~ 서서 하자~!\""]),
            ({}, ["리나가 살짝 몸을 기대는 듯한 몸짓.", "리나가 안기고 싶은 듯 팔을 뻗었다..."]),
        ],
