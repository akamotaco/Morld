...
class Mila(Character):
    ...
    FOCUS_RULES = [
        ...
        ({"activity": "정원"}, "꽃에 물을 주며 환하게 웃고 있다."),
        ({"activity": "정리"}, "부엌을 말끔하게 정리하고 있다."),
        ({"activity": "준비"}, "머리를 단정히 빗고 있다."),
    ...
    SELF_COMFORT_DISCOVERY_REACTIONS = {
        "text": [
            ({"호감": 70}, ["[밀라]", "...!", "...어, 어떡해...", "...(눈물이 글썽인다)", "...이건... 그게 아니라..."]),
    ...
    ROMANCE_REACTIONS = {
        ...
        "genital_touch:start": [
            ({"성욕": 70}, ["...더... 만져주세요...♡", "...거기... 좋아요..."]),
            ({}, ["...거기는...!", "...부끄러워요... 하지만..."]),
        ],
        "genital_touch:during": [
            ({"성욕": 80}, ["밀라가 작은 신음을 흘리고 있다.", "밀라가 당신에게 몸을 기대고 있다."]),
            ({}, ["밀라가 얼굴을 붉히며 참고 있다.", "밀라의 숨소리가 빨라지고 있다."]),
        ],
        "clit_rub:start": [
            ({"성욕": 80}, ["...으응...!! 거기는...♡", "...이상해요... 멈추지 마세요..."]),
            ({}, ["...!!!", "...거기는... 너무..."]),
        ],
        "clit_rub:during": [
            ({"성욕": 90}, ["밀라가 참지 못하고 신음을 흘리고 있다.", "밀라가 당신의 손을 꽉 잡고 있다."]),
            ({}, ["밀라가 고개를 숙인 채 몸을 떨고 있다.", "밀라의 눈이 촉촉해져 있다."]),
        ],
