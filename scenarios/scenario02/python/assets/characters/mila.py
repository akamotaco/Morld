...
class Mila(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        "french_kiss:start": [
            ({"미경험:기억:첫키스": 1}, ["...!! 처, 처음이에요...!", "...심장이 터질 것 같아요...!", "...(얼굴을 가리며) 부끄러워요..."]),
            ({"경험:총만남횟수": 10}, ["...으응... 키스... 좋아요...♡", "...또 해주세요...♡"]),
            ({}, ["...으응...♡", "...하앙... 숨이...", "...더... 해주세요...", "...음...♡"]),
        ],
        "butt_caress:start": [
        ...
        # 즉시 액션 (신규)
        "lip_lick:start": [
            ({"성욕": 40}, ["...으응... 간지러워요...♡", "...(살짝 웃는다)"]),
            ({}, ["...에헤헤... 뭐예요...", "...♡"]),
        ],
        "neck_kiss:start": [
            ({"성욕": 50}, ["...으응... 목... 약해요...♡", "...(몸이 떨린다)"]),
            ({}, ["...앗...!", "...거기는... 좀..."]),
        ],
        "breast_caress:start": [
            ({"성욕": 60}, ["...으... 부드럽게... 해주세요...♡", "...(눈을 감는다)"]),
            ({}, ["...앗... 거기는...", "...(부끄러워한다)"]),
        ],
        "nipple_stimulation:start": [
            ({"성욕": 70}, ["...으응...!! 거기... 예민해요...♡", "...안 돼... 이상해져요..."]),
            ({}, ["...앗...!!", "...너무... 직접적이에요..."]),
        ],
        ...
        # 토글 액션 (신규)
        "tongue_play:start": [
            ({"성욕": 50}, ["...(혀를 내밀며 눈을 감는다)♡", "...음...♡"]),
            ({}, ["...어... 이렇게요...?", "...(서툴게 혀를 맞댄다)"]),
        ],
        "tongue_play:during": [
            ({"성욕": 70}, ["밀라가 혀를 맞대며 달콤한 소리를 내고 있다.", "밀라가 당신의 목을 끌어안고 키스에 몰두하고 있다."]),
            ({}, ["밀라가 서툴게 혀를 맞대고 있다.", "밀라가 눈을 감고 받아들이고 있다."]),
        ],
        "butt_squeeze:start": [
            ({}, ["...앗...! 주, 주무르지 마세요...♡", "...(살짝 몸을 떤다)"]),
        ],
        "butt_squeeze:during": [
            ({"성욕": 60}, ["밀라가 당신에게 몸을 기대고 있다.", "밀라의 엉덩이가 당신의 손에 맞추어 움직인다."]),
            ({}, ["밀라가 부끄러워하면서도 가만히 있다.", "밀라의 귀가 빨갛게 물들었다."]),
        ],
        "breast_squeeze:start": [
            ({"성욕": 60}, ["...으으... 세게 하면...♡", "...(작게 신음한다)"]),
            ({}, ["...앗... 세, 세게...", "...(얼굴을 붉힌다)"]),
        ],
        "breast_squeeze:during": [
            ({"성욕": 70}, ["밀라가 참지 못하고 달콤한 신음을 흘리고 있다.", "밀라가 당신의 손 위에 자기 손을 포개고 있다."]),
            ({}, ["밀라가 얼굴을 붉히며 참고 있다.", "밀라가 눈을 감고 맡기고 있다."]),
        ],
        "breast_suck:start": [
            ({"성욕": 70}, ["...으응...! 빨면... 이상해져요...♡", "...(당신의 머리를 감싸안는다)"]),
            ({}, ["...앗...! 거기를 빨면...", "...(당황한다)"]),
        ],
        "breast_suck:during": [
            ({"성욕": 80}, ["밀라가 당신의 머리를 꽉 안고 있다.", "밀라의 달콤한 신음이 흘러나오고 있다."]),
            ({}, ["밀라가 참으려 하지만 작은 소리가 새어나온다.", "밀라가 눈을 감고 입술을 깨물고 있다."]),
        ],
        "nipple_lick:start": [
            ({"상태:수유": 1}, ["응...? 나오고 있어...?", "핥으면... 나와요... 괜찮아요...♡"]),
            ({}, ["앗... 거기 민감해요...", "응... 핥으면 이상해져요..."]),
        ],
        "nipple_suck:start": [
        ...
        "clit_lick:start": [
            ({"성욕": 80}, ["...으앗...!! 혀로...?! ♡", "...안 돼요... 거기를 핥으면...♡"]),
            ({}, ["...에엣?! 거, 거기를 핥으면...!", "...안 돼요...!!"]),
        ],
        "clit_lick:during": [
            ({"성욕": 90}, ["밀라가 허벅지를 떨며 소리를 참지 못하고 있다.", "밀라가 시트를 움켜쥐며 달콤한 비명을 지르고 있다."]),
            ({}, ["밀라가 얼굴을 베개에 묻고 견디고 있다.", "밀라의 다리가 떨리고 있다."]),
        ],
        "cunnilingus:start": [
            ({"성욕": 80}, ["...하앗...! 거기에... 혀가...♡♡", "...(다리에 힘이 풀린다)"]),
            ({}, ["...에, 에엣?! 그런... 부끄러워요...!", "...안 돼요...!"]),
        ],
        "cunnilingus:during": [
            ({"성욕": 90}, ["밀라가 참지 못하고 달콤한 비명을 지르고 있다.", "밀라가 당신의 머리를 끌어안고 있다."]),
            ({}, ["밀라가 온몸을 떨며 견디고 있다.", "밀라가 울먹이며 참고 있다."]),
        ],
        "finger_insertion:start": [
            ({"성욕": 80}, ["...으으응...!! 손가락이... 들어와요...♡", "...(몸이 크게 떨린다)"]),
            ({}, ["...앗...!! 안에... 넣으면...!", "...아파요..."]),
        ],
        "finger_insertion:during": [
            ({"성욕": 90}, ["밀라가 당신의 팔을 잡으며 달콤하게 신음하고 있다.", "밀라의 안쪽이 뜨겁게 조여오고 있다."]),
            ({}, ["밀라가 눈물을 글썽이며 견디고 있다.", "밀라가 당신의 손을 잡고 있다."]),
        ],
        "fellatio:start": [
            ({"성욕": 70}, ["...(조심스럽게 입을 벌린다)♡", "...이렇게... 하면 되나요...?"]),
            ({}, ["...에엣... 이런 거는...", "...(부끄러워하며 따른다)"]),
        ],
        "fellatio:during": [
            ({"성욕": 80}, ["밀라가 정성스럽게 해주고 있다.", "밀라가 때때로 걱정스럽게 올려다본다."]),
            ({}, ["밀라가 서툴지만 열심히 하고 있다.", "밀라가 부끄러워하면서도 멈추지 않는다."]),
        ],
        # 삽입 행위
        "vaginal_penetration:start": [
            ({"성욕": 80}, ["...으응...!! 들어와요...♡♡", "...(눈물을 글썽이며 당신을 끌어안는다)"]),
            ({}, ["...앗...!!", "...천천히... 해주세요..."]),
        ],
        ...
        "receive_penetration:start": [
            ({"성욕": 80}, ["...(조심스럽게 받아들인다)♡", "...들어오는 거... 느껴져요..."]),
            ({}, ["...앗...", "...(긴장한다)"]),
        ],
        "receive_penetration:during": [
            ({"성욕": 90}, ["밀라가 움직임에 맞추며 숨을 몰아쉬고 있다.", "밀라가 당신의 손을 꽉 잡고 있다."]),
            ({}, ["밀라가 눈을 감고 받아들이고 있다.", "밀라가 부끄러워하면서도 놓지 않는다."]),
        ],
        "anal_penetration:start": [
            ({}, ["...에엣?! 거, 거기는 안 돼요...!!", "...(겁에 질린다)"]),
        ],
        ...
        "receive_anal:during": [
            ({"성욕": 90}, ["밀라가 낯선 감각에 울음 섞인 신음을 내고 있다.", "밀라가 당신에게 매달리고 있다."]),
            ({}, ["밀라가 이를 악물며 견디고 있다.", "밀라가 눈물을 흘리고 있다."]),
        ],
        ...
        "ejaculation_internal_음부:start": [
            ...
            ({}, ["안에... 따뜻해요...♡", "으으... 안에 나왔어요...? 아이가...", "...뜨거워요... 안에서 느껴져요..."]),
        ],
        ...
        "ecstasy_V:start": [
            ({}, ["...안에서... 뜨거워요...!! ♡♡♡", "...깊은 곳이... 하앙...♡♡", "...느껴져요... 안에서 가득...♡♡♡", "...자궁이... 녹아요...♡♡"]),
        ],
        "ecstasy_M:start": [
            ({}, ["...으응...!! 입안에...♡♡", "...(눈물을 글썽이며) ...뜨거워요...♡", "...삼킬게요... 전부...♡♡♡", "...(기침하며) ...괜찮아요... ♡"]),
        ],
        "ecstasy_B:start": [
            ({}, ["...가슴이... 이상해요...!! ♡♡", "...젖꼭지만으로... 이렇게...♡♡♡", "...만지면 안 돼요... 더 이상...♡", "...가슴에서... 전기가 오는 것 같아요...♡♡"]),
        ],
        "ecstasy_P:start": [
            ({}, ["...뜨거워요...♡♡", "...(손이 떨린다) ...나오는 거예요...?♡", "...저 때문에... 이렇게...♡♡♡", "...전부 받을게요...♡♡"]),
        ],
        "ecstasy_A:start": [
            ({}, ["...에엣?! 뒤에서... 이런 느낌이...?!♡", "...안 돼요... 거기서 느끼면...♡♡", "...이상해요... 뒤가 이상해요...♡", "...(울먹이며) ...멈추지 마세요...♡♡"]),
        ],
        "ecstasy_F:start": [
            ({}, ["...으앗...!! 얼굴에...♡♡", "...(눈을 감으며) ...뜨거워요...♡", "...이런 모습... 부끄러워요...♡", "...(수줍게 웃으며) ...더러워졌어요...♡♡"]),
        ],
        "ecstasy_chain:start": [
            ({}, ["...또...?! 안 돼요... 연속으로...♡♡♡", "...멈춰요... 이러면 부서져요...♡♡", "...(온몸을 떨며) ...더 이상... 못 참아요...♡♡♡", "...머리가... 하얗게... 사랑해요...♡♡♡"]),
        ],
        "ecstasy_chain_2:start": [
            ({}, ["...또 오고 있어요...♡♡♡ 안 돼요... 멈출 수가...", "...이러면... 정말 부서져버려요...♡♡♡", "...(울먹이며 매달린다) ...무서워요... 근데 좋아요...♡♡♡", "...놓지 마세요... 제발...♡♡♡"]),
        ],
        "ecstasy_chain_3:start": [
            ({}, ["...(말을 잇지 못하고 떨고 있다) ...♡♡♡", "...더... 더 해주세요...♡♡♡♡♡", "...(눈물을 글썽이며) ...이제 아무것도 몰라요...♡♡♡", "...사랑해요... 사랑해요... 사랑해요...♡♡♡♡♡"]),
        ],
        "ecstasy_intercourse:start": [
            ({}, ["...같이...!! 같이 가요...♡♡♡", "...(당신을 꽉 안으며) ...안에서 느껴져요...♡♡♡", "...함께... 이렇게...♡♡♡", "...사랑해요... 사랑해요...!! ♡♡♡"]),
        ],

        # 정액 삼킴 반응
        "swallow_semen:start": [
            ({"성욕": 70}, ["...삼킬게요...♡", "...뜨거워요... 목으로 넘어가요...♡"]),
            ({}, ["...으읍... 삼켜야 하나요...?", "...맛이 이상해요..."]),
        ],
        ...
        # Phase 5: 거친 행위 반응
        "nipple_pinch:start": [
            ({"성욕": 70}, ["앗...! 아프지만... 이상해져요...♡", "세게 하면... 전기 오는 것 같아요...♡"]),
            ({}, ["아얏...! 아파요...!", "꼬집으면... 너무 아파요..."]),
        ],
        "breast_grab:start": [
            ({"성욕": 70}, ["앗...! 세게 잡으면... 이상해져요...♡", "가슴을... 그렇게 하면... 전기 오는 것 같아요...♡"]),
            ({}, ["아야...! 세게 잡으면 아파요...", "살살 해주세요..."]),
        ],
        "rough_finger:start": [
            ({"성욕": 70}, ["으으...! 거칠게 하면... 이상해요...♡", "안 돼요... 그렇게 하면...♡"]),
            ({}, ["아파요...! 살살 해주세요...", "너무 거칠어요..."]),
        ],
        "rough_thrust:start": [
            ({"성욕": 70}, ["으앗...! 세게... 오면...♡♡", "안쪽까지... 부서질 것 같아요...♡"]),
            ({}, ["아파요...! 천천히 해주세요...", "너무 세요..."]),
        ],
        "rough_thrust:during": [
            ({"성욕": 70}, ["밀라가 눈물을 글썽이면서도 당신을 끌어안고 있다.", "밀라가 큰 소리로 신음하며 흔들리고 있다."]),
            ({}, ["밀라가 참으며 당신의 등을 꽉 잡고 있다.", "밀라가 울먹이며 견디고 있다."]),
        ],
        "hard_anal:start": [
            ({"성욕": 70}, ["뒤를 세게...?! 으으... 이상해요...♡", "거기는... 무서운데... 느껴져요...♡"]),
            ({}, ["안 돼요...! 뒤를 그렇게 하면 아파요...!", "무서워요... 그만해 주세요..."]),
        ],
        "hard_anal:during": [
            ({"성욕": 70}, ["밀라가 베개에 얼굴을 묻으며 울음 섞인 신음을 내고 있다.", "밀라가 떨면서도 엉덩이를 내밀고 있다."]),
            ({}, ["밀라가 시트를 움켜쥐며 울고 있다.", "밀라가 눈물을 흘리며 참고 있다."]),
        ],

        # Phase 6: 삽입 중 즉시 액션 반응
        "thrust_deep:start": [
            ({"성욕": 70}, ["깊어요...! 안쪽에... 닿아요...♡♡", "거기 찌르면... 머리 하얘져요...♡"]),
            ({}, ["너무 깊어요...!", "아파요... 그렇게 깊이 하면..."]),
        ],
        "thrust_slow:start": [
            ({"성욕": 70}, ["천천히... 전부 느껴져요...♡", "이렇게 하면... 더 이상해요...♡"]),
            ({}, ["으...♡", "...느껴져요..."]),
        ],
        "grind:start": [
            ({"성욕": 70}, ["안에서 움직이면... 이상해져요...♡♡", "거기 누르면... 녹을 것 같아요...♡"]),
            ({}, ["움직이면... 이상해요...", "으... 그러면..."]),
        ],
        "ejaculate:start": [
            ({"성욕": 70}, ["뜨거워요...! 안에... 느껴져요...♡", "...(뜨거운 감각에 몸을 떤다.)"]),
            ({}, ["...(놀란 듯 눈을 크게 뜬다.)", "뜨거워요..."]),
        ],
