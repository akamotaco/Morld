...
class Mila(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        "anal_penetration:during": [
            ({"반발": 30}, ["밀라가 울면서 몸부림치고 있다. \"안 돼요...! 뒤는... 제발...!\"", "밀라가 비명을 참으며 흐느끼고 있다.", "밀라가 고개를 젓며 울고 있다. \"아파요... 그만해 주세요...!\""]),
            ({"반발": 15}, ["밀라가 눈물을 흘리며 이를 악물고 있다.", "밀라가 떨면서 고개를 숙이고 있다."]),
            ({"크기통증": 1}, ["밀라가 움찔한다. \"...뒤는 좀... 무리일 수도...\"", "밀라가 이를 악물며 눈물을 참는다. \"...크기가... 너무...\""]),
