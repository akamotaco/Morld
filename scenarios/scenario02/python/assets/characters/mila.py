...
CHARACTER_REACTIONS = {
    ...
    "light": {
        (80, 80): [
            "{name}가 당신의 가슴에 얼굴을 묻고 '사랑해요'라고 속삭이고 있다.",
            "{name}가 당신의 셔츠를 꼭 움켜쥐며 놓지 않고 있다.",
            "{name}가 행복한 눈물을 글썽이며 당신에게 안겨 있다.",
        ],
        (80, 30): [
            "{name}가 눈을 감고 편안하게 기대어 있다. 입가에 미소가 걸려 있다.",
            "{name}가 당신의 체온을 느끼며 작게 콧노래를 흥얼거리고 있다.",
        ],
        (80, -30): [
            "{name}가 얼굴을 붉히며 눈을 이리저리 굴리고 있다.",
            "{name}가 수줍게 당신의 손을 잡았다가 놓기를 반복하고 있다.",
        ],
        (30, 60): [
            "{name}의 숨이 점점 거칠어지고 있다. 손에 힘이 들어가 있다.",
            "{name}가 당신의 옷깃을 잡으며 더 가까이 오라는 듯 당기고 있다.",
        ],
        (30, 0): [
            "{name}가 조심스레 당신의 어깨에 이마를 기대고 있다.",
            "{name}가 살짝 미소 지으며 가만히 있다.",
        ],
        (-30, 0): [
            "{name}가 불안한 듯 손끝을 만지작거리며 고개를 숙이고 있다.",
            "{name}가 울 듯 말 듯한 표정으로 당신을 올려다보고 있다.",
        ],
        (-60, 30): [
            "{name}가 입술을 깨물며 눈물을 참고 있다. 몸이 가늘게 떨리고 있다.",
            "{name}가 작은 목소리로 '하지 마세요'라고 반복하고 있다.",
        ],
        (-80, 0): [
            "{name}가 눈을 감고 아무 말 없이 눈물만 흘리고 있다.",
        ],
        (80, 80, 60): [
            "{name}가 당신의 품에서 가늘게 떨며 '놓지 마요'라고 매달리고 있다.",
            "{name}가 숨을 헐떡이며 당신의 목에 얼굴을 파묻고 있다.",
        ],
    },
    ...
    "medium": {
        (80, 80): [
            "{name}가 당신의 손을 자기 가슴 위에 가져다 대며 눈을 감고 있다.",
            "{name}가 달콤한 신음을 흘리며 당신에게 몸을 맡기고 있다.",
        ],
        (80, 30): [
            "{name}가 얼굴을 붉히며 작은 소리를 참고 있다.",
            "{name}가 부끄럽지만 당신의 손길을 피하지 않고 있다.",
        ],
        (80, -30): [
            "{name}가 '부끄러워요'라며 얼굴을 가리고 있지만 손은 치우지 않는다.",
        ],
        (30, 60): [
            "{name}의 호흡이 거칠어지고 있다. 이마에 땀이 맺혀 있다.",
            "{name}가 작게 신음하며 당신의 손에 자기 손을 포개고 있다.",
        ],
        (-30, 0): [
            "{name}가 당혹스러운 표정으로 몸을 움츠리며 떨고 있다.",
            "{name}가 눈물을 글썽이며 '거기는...'이라고 작게 중얼거리고 있다.",
        ],
        (-60, 30): [
            "{name}가 울면서 가슴을 감싸고 '그만해 주세요'라고 애원하고 있다.",
        ],
        (80, 80, 60): [
            "{name}가 당신의 손을 양손으로 감싸 쥐며 숨을 참고 있다. 눈가가 젖어 있다.",
            "{name}가 입술을 깨물며 몸을 당신 쪽으로 밀착시키고 있다.",
        ],
        (80, 80, 80): [
            "{name}가 달콤한 비명을 참지 못하고 당신의 어깨를 꽉 물고 있다.",
            "{name}의 등이 활처럼 젖혀지며 온몸이 가늘게 경련하고 있다.",
        ],
    },

    # ── strong (성기/손가락/구강 등 강한 접촉) ──
    "strong": {
        (80, 80): [
            "{name}가 다리에 힘이 풀린 채 당신에게 기대어 있다.",
            "{name}가 눈물을 글썽이며 '더 해주세요'라고 간청하고 있다.",
        ],
        (80, 80, 60): [
            "{name}의 온몸이 활처럼 휘어지며 떨리고 있다.",
            "{name}가 정신없이 당신의 이름을 부르고 있다.",
        ],
        (80, 80, 100): [
            "{name}가 의식이 아득해진 듯 당신에게 매달려 있다. 눈에 초점이 없다.",
        ],
        (80, 30): [
            "{name}가 당신의 손을 꼭 잡으며 작은 소리를 내고 있다.",
        ],
        (30, 60): [
            "{name}가 참지 못하고 몸을 떨며 소리를 내고 있다.",
        ],
        (30, 60, 60): [
            "{name}가 시트를 꽉 움켜쥐며 절정 직전의 표정을 하고 있다.",
        ],
        (-30, 0): [
            "{name}가 다리를 모으며 눈물을 흘리고 있다.",
        ],
        (-60, 30): [
            "{name}가 울부짖으며 발버둥치고 있다. '거기는 안 돼요!'",
        ],
    },
    ...
    "penetration": {
        (80, 80): [
            "{name}가 당신을 꽉 끌어안으며 '사랑해요'를 반복하고 있다.",
            "{name}가 눈물을 흘리며 행복한 표정으로 당신을 감싸고 있다.",
        ],
        (80, 80, 60): [
            "{name}가 목을 젖히며 달콤한 비명을 지르고 있다.",
            "{name}의 안이 리드미컬하게 조여오고 있다.",
        ],
        (80, 80, 80): [
            "{name}가 정신을 잃어가며 당신의 이름만 중얼거리고 있다.",
            "{name}가 연속된 절정에 온몸을 떨며 눈물을 흘리고 있다.",
        ],
        (80, 80, 100): [
            "{name}가 완전히 녹아내린 듯 당신에게 매달려 있다. 숨소리만 거칠다.",
        ],
        (80, 30): [
            "{name}가 아프지만 당신의 등을 감싸안으며 참고 있다.",
            "{name}가 눈물을 글썽이며 당신과 호흡을 맞추고 있다.",
        ],
        (80, -30): [
            "{name}가 아파서 울고 있지만 당신을 놓지 않고 있다.",
        ],
        (30, 60): [
            "{name}가 당신의 이름을 부르며 허리를 맞추고 있다.",
        ],
        (30, 60, 60): [
            "{name}가 시트를 움켜쥐며 '가요...!'라고 외치고 있다.",
        ],
        (-30, 0): [
            "{name}가 눈물을 흘리며 '빼주세요'라고 작게 말하고 있다.",
        ],
        (-60, 30): [
            "{name}가 울부짖으며 '아파요, 제발 그만!'이라고 간청하고 있다.",
        ],
        (-80, 0): [
            "{name}가 소리 없이 눈물만 흘리며 의식이 멀어져 가고 있다.",
        ],
    },
    ...
    "rough": {
        (80, 30): [
            "{name}가 아프지만 당신을 놓지 않으며 '괜찮아요'라고 웃고 있다.",
        ],
        (80, -30): [
            "{name}가 아파서 울면서도 당신의 손을 꼭 잡고 있다.",
        ],
        (-30, 0): [
            "{name}가 비명을 참으며 시트를 움켜쥐고 있다. 눈물이 멈추지 않는다.",
        ],
        (-60, 30): [
            "{name}가 고통에 비명을 지르며 '살살 해주세요!'라고 울부짖고 있다.",
        ],
        (80, 30, 60): [
            "{name}가 아프면서도 달아오른 몸을 주체하지 못하고 시트를 움켜쥐고 있다.",
            "{name}가 눈물을 흘리면서도 절정에 가까워진 듯 다리에 힘이 빠지고 있다.",
        ],
    },
    ...
    "cunnilingus": {
        (80, 80): [
            "{name}가 당신의 머리를 부드럽게 쓰다듬으며 몸을 떨고 있다.",
        ],
        (80, 80, 60): [
            "{name}가 머리를 세게 잡으며 허리를 들어올리고 있다.",
            "{name}가 목을 젖히며 달콤한 비명을 참고 있다.",
        ],
        (80, 80, 80): [
            "{name}가 통제를 완전히 잃고 당신의 머리를 끌어당기고 있다.",
        ],
    },
}
