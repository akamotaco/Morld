...
class Wolf(Monster):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["늑대가 낮게 으르렁거린다.", "늑대가 이를 드러내며 뒤로 물러선다."],
        "hit_heavy": ["늑대가 날카롭게 울부짖는다.", "늑대가 비틀거리며 자세를 낮춘다."],
        "hit_crit":  ["늑대가 고통스럽게 울부짖는다.", "늑대가 땅에 쓰러지려 한다."],
...
class Bat(Monster):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["박쥐가 끽 소리를 내며 뒤로 물러선다.", "박쥐가 파르르 떨며 후퇴한다."],
        "hit_heavy": ["박쥐가 비명에 가까운 소리를 내며 날개를 접는다.", "박쥐가 제대로 날지 못하며 비틀거린다."],
        "hit_crit":  ["박쥐가 처절한 소리를 지르며 바닥으로 떨어진다.", "박쥐의 날개가 찢기며 추락한다."],
...
class Spider(Monster):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["거미가 몸을 비틀며 뒤로 물러선다.", "거미가 날카로운 소리를 낸다."],
        "hit_heavy": ["거미가 비틀거리며 다리를 접는다.", "거미가 독을 흘리며 쓰러지려 한다."],
        "hit_crit":  ["거미가 격렬하게 몸부림친다.", "거미의 다리 하나가 꺾이며 쓰러진다."],
...
class Arachne(HumanoidCreature):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["'이 따위 공격에...'", "아라크네가 불쾌한 듯 눈살을 찌푸린다."],
        "hit_heavy": ["아라크네가 고통스럽게 신음하며 비틀거린다.", "아라크네의 상반신에서 피가 흐른다."],
        "hit_crit":  ["'...크큭! 감히...!'", "아라크네가 격분하며 몸을 떤다."],
...
class Succubus(HumanoidCreature):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["'앗...'", "서큐버스가 살짝 몸을 비튼다."],
        "hit_heavy": ["'으... 이거 진심이구나.'", "서큐버스의 날개가 떨린다."],
        "hit_crit":  ["서큐버스가 고통스러운 비명을 지른다.", "'꽤... 상처가 깊어.'"],
...
class ParasiticCreature(Monster):
    ...
    COMBAT_LINES = {
        ...
        "attack":    ["생물체가 달려든다!"],
        "hit_light": ["생물체가 몸을 비틀며 물러선다.", "생물체가 끈적한 체액을 흘린다."],
        "hit_heavy": ["생물체가 끈적한 체액을 뿜으며 비틀거린다.", "생물체가 축소되듯 움츠러든다."],
        "hit_crit":  ["생물체가 처절하게 몸부림친다.", "생물체가 반으로 접히듯 쓰러진다."],
        "death":     ["생물체가 축 늘어진다."],
    }
...
class BreastParasiteCreature(ParasiticCreature):
    ...
    COMBAT_LINES = {
        ...
        "attack":    ["생물체가 촉수를 뻗는다!"],
        "hit_light": ["생물체가 움츠러든다.", "촉수가 짧게 파르르 떨린다."],
        "hit_heavy": ["생물체가 끈적한 액체를 뿜으며 물러선다.", "생물체가 축 처지며 비틀거린다."],
        "hit_crit":  ["생물체가 처절하게 몸부림친다.", "생물체의 촉수 하나가 끊어진다."],
...
class GenitalParasiteCreature(ParasiticCreature):
    ...
    COMBAT_LINES = {
        ...
        "hit_light": ["생물체가 끈적한 액체를 분비한다.", "생물체가 짧게 수축한다."],
        "hit_heavy": ["생물체가 끈적한 액체를 뿜으며 크게 비틀거린다.", "생물체가 반쯤 접히듯 후퇴한다."],
        "hit_crit":  ["생물체가 격렬하게 몸부림치며 액체를 흘린다.", "생물체가 녹아내리듯 무너진다."],
