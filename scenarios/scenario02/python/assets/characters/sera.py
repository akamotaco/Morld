...
class Sera(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        # 토글 액션 (신규)
        "tongue_play:start": [
            ({"성욕": 50}, ["...(혀가 닿자 살짝 떨린다)", "...으음..."]),
            ({}, ["...뭐하는...", "...(눈을 감는다)"]),
        ],
        "tongue_play:during": [
            ({"성욕": 70}, ["세라가 혀를 맞대며 숨을 삼킨다.", "세라의 숨소리가 거칠어지고 있다."]),
            ({}, ["세라가 눈을 감고 받아들이고 있다.", "세라가 가만히 응하고 있다."]),
        ],
        "butt_squeeze:start": [
            ({}, ["...!, ...주무르지 마...", "...(살짝 몸을 떤다)"]),
        ],
        "butt_squeeze:during": [
            ({"성욕": 60}, ["세라가 입술을 깨물며 참고 있다.", "세라가 몸을 밀착해 온다."]),
            ({}, ["세라가 눈을 피하고 있다.", "세라가 가만히 있다."]),
        ],
        "breast_squeeze:start": [
            ({"성욕": 60}, ["...으... 세게 하지 마...", "...(작게 신음한다)"]),
            ({}, ["......!", "...뭐하는 거야..."]),
        ],
        "breast_squeeze:during": [
            ({"성욕": 70}, ["세라가 참지 못하고 작은 소리를 내고 있다.", "세라가 당신의 손 위에 자기 손을 올렸다."]),
            ({}, ["세라가 얼굴을 돌리고 참고 있다.", "세라의 귀가 빨갛다."]),
        ],
        "breast_suck:start": [
            ({"성욕": 70}, ["...으응...!", "...(몸이 떨린다)"]),
            ({}, ["...!, ...뭐야...", "...바보..."]),
        ...
        "breast_suck:during": [
            ({"성욕": 80}, ["세라가 당신의 머리를 감싸안고 있다.", "세라의 신음이 점점 커지고 있다."]),
            ({}, ["세라가 눈을 꽉 감고 견디고 있다.", "세라가 입술을 깨물고 있다."]),
        ],
        "nipple_lick:start": [
        ...
        "clit_lick:during": [
            ({"성욕": 90}, ["세라가 허벅지를 떨며 소리를 참고 있다.", "세라가 시트를 움켜쥐고 있다."]),
            ({}, ["세라가 고개를 돌리며 견디고 있다.", "세라의 숨소리가 거칠다."]),
        ],
        "cunnilingus:start": [
            ({"성욕": 80}, ["...하... 거기... 혀로...!", "...(다리에 힘이 풀린다)"]),
            ({}, ["...뭐...뭐하는 거야...!", "...안 돼...!"]),
        ],
        "cunnilingus:during": [
            ({"성욕": 90}, ["세라가 참지 못하고 신음을 흘리고 있다.", "세라의 손이 당신의 머리를 움켜쥐고 있다."]),
            ({}, ["세라가 몸을 떨며 견디고 있다.", "세라가 입술을 깨물고 있다."]),
        ],
        "finger_insertion:start": [
            ({"성욕": 80}, ["...으으...!! ...손가락이...", "...(몸이 크게 떨린다)"]),
            ({}, ["...안 돼...!", "...빼..."]),
        ],
        "finger_insertion:during": [
            ({"성욕": 90}, ["세라가 당신의 팔을 잡으며 신음하고 있다.", "세라의 내부가 조여오고 있다."]),
            ({}, ["세라가 이를 악물고 견디고 있다.", "세라가 얼굴을 묻고 있다."]),
        ],
        "fellatio:start": [
            ({"성욕": 70}, ["...(조용히 입을 벌린다)", "...이상한 짓 시키지 마..."]),
            ({}, ["...왜 내가...", "...(불만스럽지만 따른다)"]),
        ],
        "fellatio:during": [
            ({"성욕": 80}, ["세라가 서툴지만 열심히 하고 있다.", "세라가 때때로 당신을 올려다본다."]),
            ({}, ["세라가 눈을 피하며 하고 있다.", "세라가 묵묵히 따르고 있다."]),
        ],
        # 삽입 행위
        "vaginal_penetration:start": [
            ({"성욕": 80}, ["...으으...!! 들어와...", "...(이를 악물며 견딘다)"]),
            ({}, ["......!!", "...하지 마..."]),
        ],
        ...
        "receive_penetration:during": [
            ({"성욕": 90}, ["세라가 움직임에 맞추며 숨을 몰아쉬고 있다.", "세라의 안에서 당신을 느끼고 있다."]),
            ({}, ["세라가 가만히 받아들이고 있다.", "세라가 눈을 감고 있다."]),
        ],
        ...
        "receive_anal:during": [
            ({"성욕": 90}, ["세라가 낯선 감각에 신음하고 있다.", "세라의 몸이 떨리고 있다."]),
            ({}, ["세라가 이를 악물고 있다.", "세라가 견디고 있다."]),
        ],
        ...
        "ejaculation_internal_음부:start": [
            ...
            ({}, ["...이 멍청이... 안에...", "...으으...! 안에 쏟으면... 어떡해...", "...뜨거워... 안에서..."]),
        ],
        ...
        "ecstasy_V:start": [
            ({}, ["...안에서... 이상해...!", "...(허리가 떨린다) ...으으...", "...깊은 곳에서... 뭔가...", "......!!! ...(말을 잃었다)"]),
        ],
        "ecstasy_M:start": [
            ({}, ["...으... 입안이...", "...(눈이 커진다) ...뜨거워...", "...삼킬 수... 없...", "...(기침하며 떨고 있다)"]),
        ],
        "ecstasy_B:start": [
            ({}, ["...가슴이... 이상해...", "...만지지 마... 더 이상...", "...(젖꼭지가 서 있다) ...으...", "...몸이 멋대로..."]),
        ],
        "ecstasy_P:start": [
            ({}, ["...(손이 떨린다)", "...이렇게 되는 거야...?", "...뜨거워...", "...(조용히 바라보고 있다)"]),
        ],
        "ecstasy_A:start": [
            ({}, ["...거기서... 이런 느낌이...?!", "...(믿을 수 없다는 표정)", "...안 돼... 뒤에서...", "...이상해... 이상해...!"]),
        ],
        "ecstasy_F:start": [
            ({}, ["......!!", "...(눈을 감는다) ...뜨거워...", "...얼굴에...", "...(수치스러운 표정)"]),
        ],
        "ecstasy_chain:start": [
            ({}, ["...또...?! ...안 돼... 멈...", "...연속으로... 무리야...!", "...(온몸이 떨린다) ...이제 한계...", "...머리가... 하얘..."]),
        ],
        "ecstasy_chain_2:start": [
            ({}, ["...또...?! ...거짓말... 이런 거...", "...안 돼... 몸이 멋대로...", "...(떨리는 숨을 내쉰다) ...이상해...", "......아직... 끝이 아니야...?"]),
        ],
        "ecstasy_chain_3:start": [
            ({}, ["...(말을 잇지 못한다)", "......더... ...더......", "...(눈이 초점을 잃는다) ...몰라... 이제...", "...멈추지 마......"]),
        ],
        "ecstasy_intercourse:start": [
            ({}, ["...같이...?! ...으으...!!", "...(당신을 꽉 잡는다) ...안에서...", "...동시에... 이런...", "......!!! ...(말없이 매달린다)"]),
        ],
        ...
        # Phase 5: 거친 행위 반응
        "nipple_pinch:start": [
            ({"성욕": 70}, ["...으으...! 아프지만... 이상해...", "...세게 하지 마... 하지만..."]),
            ({}, ["...아파...!", "...꼬집지 마... 죽을래...?"]),
        ],
        "breast_grab:start": [
            ({"성욕": 70}, ["...으...! 세게 잡으면... 이상해...", "...거기... 그렇게 하면... 목소리가..."]),
            ({}, ["...아파...! 세게 잡지 마...", "...뭐 하는 거야..."]),
        ],
        "rough_finger:start": [
            ({"성욕": 70}, ["...거칠게... 으으...!", "...난폭하게 하면... 이상해져..."]),
            ({}, ["...아파... 그만해...", "...너무 거칠어..."]),
        ],
        "rough_thrust:start": [
            ({"성욕": 70}, ["...으으...! 세게... 하지 마...", "...거칠게 하면... 목소리가..."]),
            ({}, ["...아파...! 천천히 해...", "...너무 세잖아..."]),
        ],
        "rough_thrust:during": [
            ({"성욕": 70}, ["세라가 이를 악물면서도 허리를 맞추고 있다.", "세라가 신음을 참지 못하고 있다."]),
            ({}, ["세라가 얼굴을 묻고 참고 있다.", "세라가 이를 악물며 견디고 있다."]),
        ],
        "hard_anal:start": [
            ({"성욕": 70}, ["...뒤를... 세게...?! 으으...!", "...거기는... 아프다고..."]),
            ({}, ["...안 돼...! 뒤를 그렇게 하면...!", "...아파... 그만..."]),
        ],
        "hard_anal:during": [
            ({"성욕": 70}, ["세라가 베개를 움켜쥐며 신음하고 있다.", "세라가 낯선 쾌감에 떨고 있다."]),
            ({}, ["세라가 시트를 꽉 잡으며 참고 있다.", "세라가 고통스러운 표정으로 견디고 있다."]),
        ],

        # Phase 6: 삽입 중 즉시 액션 반응
        "thrust_deep:start": [
            ({"성욕": 70}, ["...깊어...! 안쪽까지... 으으...", "...거기... 닿으면 이상해..."]),
            ({}, ["...너무 깊어...!", "...아파... 천천히..."]),
        ],
        "thrust_slow:start": [
            ({"성욕": 70}, ["...천천히... 느껴져...", "...이렇게 하면... 더 이상해..."]),
            ({}, ["...으...", "...뭐 하는 거야..."]),
        ],
        "grind:start": [
