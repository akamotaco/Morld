...
class Sera(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        "ejaculation_internal_음부:start": [
            ...
            ({"성욕": 80, "경험:질내사정": 5}, ["...안에 쏟아도... 괜찮아...", "...더... 안에..."]),
        ...
        # ── NPC 선호 체위 요구 (대사만, 실제 체위 변경은 플레이어 선택) ──
        "npc_position_request:standing_face": [
            ({"성욕": 80}, ["\"...서서. 안고 해줘.\"", "\"...일어서서 하자.\" 세라가 짧게 말했다."]),
            ({}, ["세라가 묵묵히 몸을 세우려 한다.", "세라가 일어서고 싶은 듯한 몸짓..."]),
        ],
        "npc_position_request:doggy": [
            ({"성욕": 80}, ["\"...뒤에서. 더 깊이.\"", "세라가 말없이 엉덩이를 내밀었다."]),
            ({}, ["세라가 묵묵히 몸을 엎드렸다.", "세라가 등을 돌리며 자세를 바꾸려 한다..."]),
        ],
