...
class Sera(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        "nipple_pinch:start": [
            ((50, 70), ["...으으...! 아프지만... 이상해...", "...세게 하지 마... 하지만..."]),
            ((50, 20), ["...아파...!", "...꼬집지 마... 죽을래...?"]),
        ],
        "breast_grab:start": [
            ((50, 70), ["...으...! 세게 잡으면... 이상해...", "...거기... 그렇게 하면... 목소리가..."]),
            ((50, 20), ["...아파...! 세게 잡지 마...", "...뭐 하는 거야..."]),
        ],
        "rough_finger:start": [
            ((50, 70), ["...거칠게... 으으...!", "...난폭하게 하면... 이상해져..."]),
            ((50, 20), ["...아파... 그만해...", "...너무 거칠어..."]),
        ],

        # ── 토글형 행위 :start (2D 좌표) ──
        "hug:start": [
            ((80, 70), ["...좋다...", "...따뜻하군...", "...이대로 있자..."]),
            ((80, 20), ["...싫진 않다...", "...안아줘..."]),
            ((20, 70), ["...흥.", "...원하면 그렇게 해."]),
            ((20, 20), ["......", "...뭐냐.", "...놓아라."]),
        ],
        ...
        "tongue_play:start": [
            ((80, 70), ["...(혀가 닿자 살짝 떨린다)", "...으음..."]),
            ((80, 20), ["...(눈을 감는다)"]),
            ((20, 70), ["...으음...", "...(떨린다)"]),
            ((20, 20), ["...뭐하는..."]),
        ],
        "breast_squeeze:start": [
            ((50, 70), ["...으... 세게 하지 마...", "...(작게 신음한다)"]),
            ((50, 20), ["......!", "...뭐하는 거야..."]),
        ],
        "breast_suck:start": [
            ((50, 70), ["...으응...!", "...(몸이 떨린다)"]),
        ...
        "cunnilingus:start": [
            ((50, 70), ["...하... 거기... 혀로...!", "...(다리에 힘이 풀린다)"]),
            ((50, 20), ["...뭐...뭐하는 거야...!", "...안 돼...!"]),
        ],
        "finger_insertion:start": [
            ((50, 70), ["...으으...!! ...손가락이...", "...(몸이 크게 떨린다)"]),
            ((50, 20), ["...안 돼...!", "...빼..."]),
        ],
        "fellatio:start": [
            ((80, 70), ["...(조용히 입을 벌린다)", "...해줄게..."]),
            ((20, 70), ["...(조용히 입을 벌린다)", "...이상한 짓 시키지 마..."]),
            ((20, 20), ["...왜 내가...", "...(불만스럽지만 따른다)"]),
        ],
        "vaginal_penetration:start": [
            ((80, 70), ["...으으...!! 들어와...", "...(이를 악물며 받아들인다)"]),
            ((20, 70), ["...으으...!!", "...(이를 악물며 견딘다)"]),
            ((20, 20), ["......!!", "...하지 마..."]),
        ],
        ...
        "rough_thrust:start": [
            ((50, 70), ["...으으...! 세게... 하지 마...", "...거칠게 하면... 목소리가..."]),
            ((50, 20), ["...아파...! 천천히 해...", "...너무 세잖아..."]),
        ],
        "hard_anal:start": [
            ((50, 70), ["...뒤를... 세게...?! 으으...!", "...거기는... 아프다고..."]),
            ((50, 20), ["...안 돼...! 뒤를 그렇게 하면...!", "...아파... 그만..."]),
        ],

        # ── :during — 특수 조건만 유지 (나머지는 generator) ──
        "vaginal_penetration:during": [
        ...
        # ── 삽입 중 즉시 액션 (2D 좌표) ──
        "thrust_deep:start": [
            ((50, 70), ["...깊어...! 안쪽까지... 으으...", "...거기... 닿으면 이상해..."]),
            ((50, 20), ["...너무 깊어...!", "...아파... 천천히..."]),
        ],
        "thrust_slow:start": [
            ((50, 70), ["...천천히... 느껴져...", "...이렇게 하면... 더 이상해..."]),
            ((50, 20), ["...으...", "...뭐 하는 거야..."]),
        ],
        "grind:start": [
            ((50, 70), ["...으으... 안에서 움직이면...", "...거기 누르면... 이상해져..."]),
            ((50, 20), ["...움직이지 마...", "...이상한 짓 하지 마..."]),
        ],
        "ejaculate:start": [
            ((50, 70), ["...(뜨거운 감각에 몸을 떤다.)", "...뜨거워... 안에..."]),
            ((50, 20), ["...(놀란 듯 몸이 굳는다.)", "..."]),
        ],
