...
class Sera(Character):
    ...
    props = {
        ...
        # Phase 2 후반 성향 성애 override (stoic 베이스 + 마조 성향 장인)
        "성향:마조": 30,  # stoic 기본 0 → 30 (내색 안 하는 마조)
        "나이": 23,
        "상태:성욕": 0, "상태:질투": 0,
        "상태:피로": 0, "상태:기분": 5,
        "can:lie_down": 1,
    ...
    ROMANCE_REACTIONS = {
        ...
        "thrust_normal:during": [
            ...
            ({}, ["세라가 말없이 흔들리고 있다.", "세라가 이를 악물고 숨을 고르고 있다.", "세라의 몸이 리듬에 맞춰 떨린다."]),
        ],
        "nipple_suck:during": [
            ...
            ({}, ["세라가 입술을 깨물며 참고 있다.", "세라가 가슴을 맡긴 채 숨을 고른다.", "세라의 귀 끝이 붉게 물들어 있다."]),
        ],
        ...
        "ejaculation_internal_음부:start": [
            ({"배란": True, "반발": 15}, ["...하필 오늘이야...? 배란일이라고...!", "...(이를 악문다) ...임신 확정이야. 죽여버린다.", "...오늘이란 걸... 모르고 했다고?"]),
            ({"배란": True}, ["...오늘... 배란일이야. ...알고 있지?", "...(한숨) ...각오했어. 오늘은 안에 쏟아도 돼.", "...책임져. 오늘은 정말로 생길 거야."]),
            ({"반발": 30}, ["...안에 쏟으면 죽여버린다.", "...빼. 지금 당장.", "...죽고 싶어?"]),
            ({"반발": 15}, ["...안에는 안 돼.", "...빼라고.", "...제발... 안에는..."]),
            ({"성욕": 80, "경험:질내사정": 5}, ["...안에 쏟아도... 괜찮아...", "...더... 안에..."]),
            ({"경험:질내사정": 3}, ["...또... 안에...", "...뜨거워... 이제 익숙해..."]),
            ({}, ["...안에... 넣는군.", "...(숨을 삼킨다) ...뜨거워.", "...끝났나."]),
        ],
        "ejaculation_internal_항문:start": [
            ({"반발": 30}, ["...엉덩이에 쏟으면 죽여버린다.", "...빼. 지금 당장. 뒤는 안 돼.", "...변태... 죽고 싶어?"]),
            ({"반발": 15}, ["...뒤쪽은 진짜 안 돼.", "...빼라고. 거긴 싫다고.", "...제발... 뒤는..."]),
            ({"성욕": 80, "경험:항문": 5}, ["...뒤에 쏟아도... 괜찮아...", "...엉덩이도... 더..."]),
            ({"경험:항문": 3}, ["...또... 뒤에... 뜨거워...", "...이제 엉덩이도 익숙해..."]),
            ({}, ["...뒤에... 넣었어.", "...(허리가 굳는다) ...윽.", "...묘한 느낌이야."]),
        ],
        "ejaculation_internal_구강:start": [
            ({"반발": 30}, ["...(입을 꽉 다문 채 살기를 뿜는다.) ...뱉을 거야.", "...미친 거야? 입에...", "...(이를 악물고 흘린다.) ...죽여버린다."]),
            ({"반발": 15}, ["...입에는 안 돼.", "...(입 안에 머금은 채 고개를 돌린다.) ...최악이야."]),
            ({"성욕": 80, "경험:구강": 5}, ["...입에 쏟아도... 괜찮아...", "...(차분히 머금는다.) ...더..."]),
            ({"경험:구강": 3}, ["...또... 입에... 뜨거워...", "...익숙해... 이런 거..."]),
            ({}, ["...(입 안에 받아낸다)", "...(말없이 삼킨다)", "...묘한 맛이야."]),
        ],

        # ── 체내 정액 최대치 도달 (overflow) ──
        "ejaculation_internal_음부_overflow:start": [
            ({"반발": 15}, ["...배 안이... 넘쳐. ...최악.", "...(흘러넘치는 정액에 이를 악문다) ...양 조절 좀 해."]),
            ({}, ["...배 안이... 가득... (흘러내린다)", "...(허벅지를 타고 흐른다) ...많이 쏟았네..."]),
        ],
        "ejaculation_internal_항문_overflow:start": [
            ({"반발": 15}, ["...뒤가... 터질 것 같아. ...변태.", "...(엉덩이 밖으로 흐른다) ...더는 무리."]),
            ({}, ["...뒤쪽이... 넘쳐. (차분히)", "...(허벅지로 흐르는 정액) ...꽤 쏟았어."]),
        ],
        "ejaculation_internal_구강_overflow:start": [
            ({"반발": 15}, ["...(입 밖으로 흐른다) ...최악이야.", "...(뱉어내며) ...양 조절도 못해?"]),
            ({}, ["...(입 가득 머금은 채 흐른다) ...으...", "...(턱을 타고 흐른다) ...많기도 해..."]),
        ],

        # ── raw 질삽입 경고 (콘돔 없이) ──
        "raw_vaginal_warning:start": [
            ({"반발": 15}, ["...콘돔 없이? ...죽고 싶어?", "...(이를 악문다) ...책임 못 지면 죽여버린다."]),
            ({}, ["...콘돔 안 쓰는구나. (차분히)", "...(살짝 긴장한 눈빛) ...각오 돼 있지?"]),
        ],
        ...
        "pull_out_얼굴:start": [
            ({"반발": 15}, ["...얼굴에...? 죽여버린다.", "...(살기) ...각오해.", "...(눈에 들어와) ...최악이야."]),
            ({"성욕": 80}, ["...얼굴에... (눈을 감고 받아들인다) ...뜨거워...", "...(볼에 묻은 정액을 손으로 훑는다) ...하앗..."]),
            ({}, ["...얼굴에 나왔어. (닦으려 한다)", "...(이를 악물며) ...책임져."]),
        ],
        "pull_out_가슴:start": [
            ({"반발": 15}, ["...가슴에...! (팔로 가리려 한다) ...빼라고.", "...(경멸) ...이런 짓을."]),
            ({"성욕": 80}, ["...가슴에... 뜨거워... (살짝 숨을 삼킨다)", "...(가슴 위 정액을 만진다) ...많이 쏟았어..."]),
            ({}, ["...가슴에 묻었어. (내려다본다)", "...(닦으려 손을 뻗는다) ...최악이야."]),
        ],
        "pull_out_배:start": [
            ({"반발": 15}, ["...배에... 끈적해. (찡그린다)", "...(배 위 정액을 닦으며) ...최악."]),
            ({"성욕": 80}, ["...배에... 뜨거워... (배를 매만진다)", "...(배 위 정액을 느끼며) ...많네..."]),
            ({}, ["...배에 나왔어. (내려다본다)", "...(배를 닦으려 한다) ...으."]),
        ],
        "pull_out_엉덩이:start": [
            ({"반발": 15}, ["...엉덩이에... 변태. (어깨 너머로 노려본다)", "...(허리를 비틀며) ...죽여버린다."]),
            ({"성욕": 80}, ["...엉덩이에... (허리를 살짝 든다) ...뜨거워...", "...(엉덩이 위 정액을 느낀다) ...하..."]),
            ({}, ["...엉덩이에. (뒤돌아본다)", "...(손으로 닦는다) ...최악."]),
        ],
        ...
        "npc_autonomy:start": [
            ({"성욕": 90}, ["세라가 이를 악물고 스스로 움직이기 시작했다.", "\"...내가 하겠어.\" 세라가 직접 행동에 나섰다."]),
            ({}, ["세라가 말없이 스스로 움직이기 시작했다.", "세라가 묵묵히 스스로 행동했다..."]),
        ],
        "npc_autonomy:switch": [
            ({}, ["세라가 방식을 바꿨다.", "세라가 잠시 멈췄다가 다시 움직였다..."]),
        ],
        "npc_autonomy_fellatio:start": [
            ({"성욕": 90}, ["\"...이렇게.\" 세라가 입으로 가져갔다.", "세라가 거친 숨을 내쉬며 입에 머금었다."]),
            ({}, ["세라가 묵묵히 입으로 가져갔다.", "세라가 망설임 없이 입에 가져갔다..."]),
        ],
        "npc_autonomy_penis_rub:start": [
            ({"성욕": 90}, ["세라가 굳은 손으로 쥐고 움직였다.", "\"...이렇게 해.\" 세라가 직접 손으로 자극했다."]),
            ({}, ["세라가 손으로 쥐고 움직였다.", "세라가 묵묵히 손놀림을 시작했다..."]),
        ],
        "npc_autonomy_rest:start": [
            ({}, ["세라가 거칠게 숨을 내쉰다.", "...(세라가 잠시 숨을 골랐다.)"]),
        ],
        "npc_autonomy_self_breast:start": [
            ({"성욕": 90}, ["세라가 굳은 손으로 자기 가슴을 움켜쥐었다.", "\"...이렇게 해야만...\" 세라가 스스로 가슴을 감쌌다."]),
            ({}, ["세라가 묵묵히 자기 가슴을 쥐었다.", "세라가 거친 손으로 스스로 가슴을 자극했다..."]),
        ],
        "npc_autonomy_self_nipple:start": [
            ({"성욕": 90}, ["세라가 이를 악물고 유두를 비틀었다.", "\"...하아...\" 세라가 거친 손으로 유두를 자극했다."]),
            ({}, ["세라가 묵묵히 유두를 자극했다.", "세라가 이를 악물며 스스로 유두를 건드렸다..."]),
        ],
        "npc_autonomy_self_clit:start": [
            ({"성욕": 90}, ["세라가 거친 숨을 내쉬며 클리토리스를 자극했다.", "\"...참을 수 없군.\" 세라가 스스로 몸을 자극했다."]),
            ({}, ["세라가 묵묵히 클리토리스를 자극했다.", "세라가 말없이 자기 몸을 건드렸다..."]),
        ],
        "npc_autonomy_self_vaginal:start": [
            ({"성욕": 90}, ["세라가 망설임 없이 손가락을 자기 안에 삽입했다.", "\"...이게... 필요해.\" 세라가 스스로를 채웠다."]),
            ({}, ["세라가 말없이 손가락을 자기 안에 넣었다.", "세라가 거친 호흡으로 스스로를 채웠다..."]),
        ],
        "npc_autonomy_self_anal:start": [
            ({"성욕": 90}, ["세라가 망설임 없이 뒤쪽을 자극했다.", "\"...이쪽도 괜찮아.\" 세라가 묵묵히 항문을 건드렸다."]),
            ({}, ["세라가 묵묵히 뒤쪽을 자극하기 시작했다.", "세라가 말없이 항문을 건드렸다..."]),
        ],
        "npc_insertion_request:vaginal": [
            ({"성욕": 90}, ["\"...삽입해.\"", "\"...들어와.\" 세라가 짧게 말했다."]),
            ({}, ["세라가 묵묵히 다리를 벌렸다.", "세라가 허리를 낮추며 아래를 내보였다..."]),
        ],
        "npc_insertion_request:anal": [
            ({"성욕": 90}, ["\"...뒤로. 깊이.\"", "\"...항문으로. 해.\""]),
            ({}, ["세라가 말없이 엉덩이를 내밀었다.", "세라가 묵묵히 뒤쪽을 내보였다..."]),
        ],

        # ── 트랜스 상태 대사 (Phase 1.8) ──
        "trance:start": [
            ({}, ["\"...흡... 하아... 아...\"", "세라가 거친 숨을 몰아쉬었다...", "\"...크... 으...\""]),
        ],
        "trance_deep:start": [
            ({}, ["\"...크읏... 아으... 하아...\"", "세라가 이를 악물며 신음했다...", "\"...우... 아... 크읏...\" 세라의 목소리가 잦아들었다.",
                  "\"...{beloved}...\" 세라의 거친 숨결에 낯선 이름이 섞였다.", "\"...{beloved}...\" 세라가 무의식 중에 불렀다."]),
        ],
        "post_trance:start": [
            ({}, ["세라가 거친 숨을 내쉬며 시선을 피했다. \"...아무것도 아니다.\"", "\"...방심했군.\" 세라가 짧게 말했다.", "세라가 천천히 호흡을 가다듬으며 등을 돌렸다. \"...잊어라.\""]),
        ],
