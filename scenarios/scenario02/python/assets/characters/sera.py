...
class Sera(Character):
    ...
    ROMANCE_REACTIONS = {
        ...
        "anal_penetration:during": [
            ({"반발": 30}, ["세라가 이를 악물고 거칠게 저항한다.", "세라가 뻣뻣하게 몸을 비틀며 벗어나려 한다.", "세라의 눈에 분노가 타오르고 있다."]),
            ({"반발": 15}, ["세라가 고개를 숙이고 참고 있다.", "세라가 눈을 질끈 감고 입술을 깨문다."]),
            ({"크기통증": 1}, ["세라가 찡그린다. \"뒤는... 더 아파...\"", "세라가 이를 악물며 버틴다. \"...크... 빼...\""]),
        ],
        "nipple_suck:during": [
            ...
            ({}, ["세라가 숨을 참으며 눈을 감고 있다.", "세라가 살짝 몸을 떨고 있다."]),
        ],
