...
class PineForest(Location):
    ...
    def instantiate(self, location_id: int, region_id: int):
        ...
        pine1 = PineTree()
        self.add_object(pine1, x=150)  # 숲 중앙
...
class OakForest(Location):
    ...
    def instantiate(self, location_id: int, region_id: int):
        ...
        oak1 = OakTree()
        self.add_object(oak1, x=150)  # 숲 중앙
...
class DeepForest(Location):
    ...
    def instantiate(self, location_id: int, region_id: int):
        ...
        burrow = RabbitBurrow()
        self.add_object(burrow, x=200)  # 숲속 깊은 곳
...
class ForestCabin(Location):
    ...
    def instantiate(self, location_id: int, region_id: int):
        ...
        wardrobe = Wardrobe()
        wardrobe_id = self.add_object(wardrobe, x=20)  # 방 안쪽
