...
class Bathtub(Object):
    unique_id = "bathtub"
    name = "나무 욕조"
    actions = ["call:use:목욕하기", "script:debug_props:속성 보기"]
...
class Washbasin(Object):
    unique_id = "washbasin"
    name = "세면대"
    actions = ["call:use:세수하기", "script:debug_props:속성 보기"]
...
class Bed(Object):
    unique_id = "bed"
    name = "침대"
    actions = ["call:sleep:잠자기", "call:rest:누워있기", "script:debug_props:속성 보기"]
...
class Mirror(Object):
    unique_id = "mirror"
    name = "거울"
    actions = ["call:look:거울 보기", "script:debug_self_props:나를 돌아보기", "script:debug_props:속성 보기"]
...
class CorridorWindow(Object):
    ...
    name = "복도 창문"
    actions = ["call:look:밖을 보기", "script:debug_props:속성 보기"]
