...
class Fireplace(Object):
    unique_id = "fireplace"
    name = "벽난로"
    actions = ["script:fireplace_look:살펴보기", "script:debug_props:속성 보기"]
    focus_text = {
...
class OldSofa(Object):
    unique_id = "old_sofa"
    name = "낡은 소파"
    actions = ["script:sofa_sit:앉기", "script:debug_props:속성 보기"]
...
class Bookshelf(Object):
    unique_id = "bookshelf"
    name = "책장"
    actions = ["script:bookshelf_look:살펴보기", "script:debug_props:속성 보기"]
...
class DiningTable(Object):
    ...
    name = "긴 식탁"
    actions = ["script:table_look:살펴보기", "script:debug_props:속성 보기"]
...
class Stove(Object):
    unique_id = "stove"
    name = "아궁이"
    actions = ["script:stove_look:살펴보기", "script:debug_props:속성 보기"]
...
class Cupboard(Object):
    unique_id = "cupboard"
    name = "찬장"
    actions = ["script:cupboard_look:살펴보기", "script:debug_props:속성 보기"]
...
class Bathtub(Object):
    unique_id = "bathtub"
    name = "나무 욕조"
    actions = ["script:bath_use:목욕하기", "script:debug_props:속성 보기"]
...
class Washbasin(Object):
    unique_id = "washbasin"
    name = "세면대"
    actions = ["script:washbasin_use:세수하기", "script:debug_props:속성 보기"]
...
class StorageShelf(Object):
    ...
    name = "선반"
    actions = ["script:shelf_look:살펴보기", "script:debug_props:속성 보기"]
...
class Bed(Object):
    unique_id = "bed"
    name = "침대"
    actions = ["script:bed_sleep:잠자기", "script:bed_rest:누워있기", "script:debug_props:속성 보기"]
...
class SmallDesk(Object):
    ...
    name = "작은 책상"
    actions = ["script:desk_look:살펴보기", "script:debug_props:속성 보기"]
...
class Mirror(Object):
    unique_id = "mirror"
    name = "거울"
    actions = ["script:mirror_look:거울 보기", "script:debug_self_props:나를 돌아보기", "script:debug_props:속성 보기"]
...
class CorridorWindow(Object):
    ...
    name = "복도 창문"
    actions = ["script:window_look:밖을 보기", "script:debug_props:속성 보기"]
...
class Vase(Object):
    unique_id = "vase"
    name = "화병"
    actions = ["script:vase_look:살펴보기", "script:debug_props:속성 보기"]
