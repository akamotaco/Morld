...
class MainUnderstandSituation(Quest):
    ...
    dialogs = {
        ...
        # 완료 시 결과 텍스트 (동적 변수: met_npc)
        "result": "{met_npc}(이)라는 사람과 만나서 이야기했다.\n이곳의 사정을 조금은 알게 되었다.\n다른 사람들도 있다는 것을 알았다.",
    }
...
class MainMeetEveryone(Quest):
    ...
    dialogs = {
        ...
        "result": "저택에 사는 모든 사람을 만났다.\n밀라, 세라, 리나, 유키, 엘라.\n각자 다른 성격과 역할을 가진 사람들이다.\n이제 이곳이 조금은 익숙해진 것 같다.",
    }
...
class SubMeetMila(Quest):
    ...
    dialogs = {
        ...
        "result": "부엌을 관리하는 밀라를 만났다.\n보기만 해도 푸근한 사람이다.\n저택의 살림을 도맡아 하고 있는 듯하다.",
    }
...
class SubMeetSera(Quest):
    ...
    dialogs = {
        ...
        "result": "숲에서 사냥을 하는 세라를 만났다.\n말수가 적고 날카로운 인상이다.\n하지만 신뢰할 수 있는 사람처럼 느껴진다.",
    }
...
class MainJourneyToCity(Quest):
    ...
    dialogs = {
        ...
        "result": "밀라의 안내로 도시까지 가는 길을 알게 되었다.\n도시는 생각보다 활기찬 곳이었다.\n여러 가게들이 있고, 필요한 물건을 구할 수 있을 것 같다.",
    }
...
class SubMeetElla(Quest):
    ...
    dialogs = {
        ...
        "result": "카페 주인 엘라를 만났다.\n쾌활하고 사교적인 성격이다.\n맛있는 음식과 따뜻한 대화가 있는 곳이다.",
    }
