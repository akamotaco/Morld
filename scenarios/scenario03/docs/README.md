...
| [mvp.md](mvp.md) | **MVP 반복 운영 루프** — cycle/결번 재보급/보고서/Hybrid 대화 통합. 최신 | v0.3 |
| [demo.md](demo.md) | 데모(현 튜토리얼) 흐름, 14단계 시퀀스, 건축/진행/분대/탐사/전투 시스템 | v0.2.4 |
...
- [x] 분대/탐사/전투 구현 (v0.2.4)
  - squad.py (분대 편성/공세레벨/대열순번)
  - mapgen.py (BSP 동적 맵 생성)
  - expedition.py (원정 라이프사이클)
  - combat.py (자동 전투 해결)
  - CRTConsole UI (분대편성/진군/퇴각)
  - 이벤트 연결 (Step 8-14 완성)
  - 테스트 155개 통과 (13 modules)
- [x] MVP 반복 운영 루프 (v0.3, 2026-07) — [mvp.md](mvp.md)
  - cycle.py (운행 주기: 보급→편성→탐사→귀환→보고서)
  - 위협/전리품 실배치, 사망/결번, vita 성장, 인간성 마모
  - 차기 시리얼 재보급 (트라우마 계승)
