...
class MultiStagePipeline:
    def __init__(self, npc, samples, cb):
        ...
        self.stage1 = StructuralSampler(self.grammar, bandwidth=0.8, temperature=0.4)
...
def test_inner_outer_ablation(pipe, intents: List[str], n_trials: int = 12):
    ...
    ablated_pipe.stage1 = StructuralSampler(pipe.grammar, bandwidth=0.8, temperature=0.4)
